                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="spice-item">
                            <img src="assets/images/product-slide.png" alt="মরিচ গুড়া">
                            <p>মরিচ গুড়া</p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="spice-item">
                            <img src="assets/images/product-slide.png" alt="হলুদ">
                            <p>হলুদ</p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="spice-item">
                            <img src="assets/images/product-slide.png" alt="জিরা গুড়া">
                            <p>জিরা গুড়া</p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="spice-item">
                            <img src="assets/images/product-slide.png" alt="ধনিয়া">
                            <p>ধনিয়া</p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="spice-item">
                            <img src="assets/images/product-slide.png" alt="তেজ পাতা">
                            <p>তেজ পাতা</p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="spice-item">
                            <img src="assets/images/product-slide.png" alt="দারুচিনি">
                            <p>দারুচিনি</p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="spice-item">
                            <img src="assets/images/product-slide.png" alt="এলাচ">
                            <p>এলাচ</p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="spice-item">
                            <img src="assets/images/product-slide.png" alt="গরম মসলা">
                            <p>গরম মসলা</p>
                        </div>
                    </div>
                    <div class="swiper-slide">
